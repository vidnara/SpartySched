...
class _RegisterState extends State<Register> {
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: const OutlineInputBorder(
                  borderRadius: BorderRadius.all(Radius.elliptical(90.0, 0)),
                ),
                filled: true,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                border: const OutlineInputBorder(
                  borderRadius: BorderRadius.all(Radius.elliptical(90.0, 0.0)),
  ...
  void _registerAccount() async {
    ...
    if (user != null) {
      ...
      String name =
          (type == 0) ? _displayName.text : _displayName.text;
      String accountType = (type == 0) ? 'Tutor' : 'Student';
      ...
      // set data according to type (Tutor or Student)
